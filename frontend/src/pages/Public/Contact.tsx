...
export default function Contact() {
  return (
    <>
      <PageMeta title="Contacto" description="Información de contacto, horarios y ubicación" />
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Estamos aquí para ayudarte con tus necesidades técnicas
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  <span className="text-gray-700 dark:text-gray-300 font-medium">Lunes - Viernes</span>
                  <span className="text-gray-600 dark:text-gray-400">9:00 AM - 7:00 PM</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  <span className="text-gray-700 dark:text-gray-300 font-medium">Sábado</span>
                  <span className="text-gray-600 dark:text-gray-400">9:00 AM - 2:00 PM</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-gray-700 dark:text-gray-300 font-medium">Domingo</span>
                  <span className="text-red-600 dark:text-red-400 font-medium">Cerrado</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Referencias:</h3>
